...
class ChildForm extends Component {
  ...
  //   };
  homeId = this.props.navigation.getParam("homeId");
  render() {
    // if (this.props.user)
    //   return this.props.navigation.replace("ListOfHomesScreen");
    const { name, image, dob, medical_history, allergies, age } = this.state;
    return (
        ...
        <View style={styles.textColumn}>
          ...
          <View style={styles.rect}>
            <View style={styles.rect3Column}>
              <ScrollView contentContainerStyle={winHeight}>
...
const mapDispatchToProps = dispatch => ({
  addChild: (homeId, childObj, navigation) =>
    dispatch(addChild(homeId, childObj, navigation))
});
